...
export function HandshakeIcon({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M2.5 12.5l3.6-3.4a2 2 0 012.2-.3l1.9.9M21.5 12.5l-3.6-3.4a2 2 0 00-2.2-.3l-1.9.9"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M8.2 9.7l3 2.9c.5.5.5 1.3 0 1.8l-.3.3a1.3 1.3 0 01-1.9 0l-2-2M15.8 9.7l-3.6 3.5M10.8 14.4l1 1a1.3 1.3 0 001.9 0l.3-.3c.5-.5.5-1.3 0-1.8"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
